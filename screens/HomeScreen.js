    ...
    <SafeAreaView className="flex-1 bg-white relative">
      ...
      <View className="px-6 mt-8 space-y-3">
        ...
        <Text className="text=[#3C6072] text-base">
          Embark on your journey with a smile, Enjoy the trip with good moments
          all the while.
        </Text>
      </View>
      ...
      <View className="flex-1 relative items-center justify-center ">
        ...
        <TouchableOpacity
          ...
          className="absolute bottom-20 w-24 h-24 borderl-l-2 border-r-2 border-t-4 border-[#00BCC9] rounded-full items-center justify-center"
        >
          <Animatable.View
            animation={"pulse"}
            easing="ease-in-out"
